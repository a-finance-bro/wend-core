...
--    belonging to OTHER USERS. A recall on the founder's account returned a node
--    id owned by test@test.com. getNodeDetails refused to expand it (it filters
...
-- scope is a compile error instead of a silent cross-tenant read.
